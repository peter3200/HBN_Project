...
ResultsDir="/fslhome/mpeter55/fsl_groups/fslg_csf_autism/compute/HBN_Project/output/release1-7"
ResultsSuffix="FinalStats.txt"
OutDir="/fslhome/mpeter55/fsl_groups/fslg_csf_autism/compute/HBN_Project/final_results"
timestamp=str(int(time.time()))
outfile=OutDir+"/EaCSF_results_1.7.7_T1only_release1-7_"+timestamp+".csv"
