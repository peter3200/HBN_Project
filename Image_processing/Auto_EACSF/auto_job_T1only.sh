...
subj=$1
release=release1-7
subjDir=/fslhome/mpeter55/fsl_groups/fslg_csf_autism/compute/HBN_Project/preproc/${release}/${subj}

T1_Dir=~/fsl_groups/fslg_csf_autism/compute/HBN_Project/preproc/${release}
T1_file_extension='.nii.gz'                   

BinDir='/fslhome/mpeter55/Downloads/Software/Auto_EACSF-1.7.7-Linux/bin/'
ParamsTemplate=/fslhome/mpeter55/fsl_groups/fslg_csf_autism/compute/HBN_Project/code/auto_code/7Sept_param.json
OutputDir=/fslhome/mpeter55/fsl_groups/fslg_csf_autism/compute/HBN_Project/output/${release}
...
T1_filename=$T1_Dir/${subj}/anat/${subj}_T1_resampled$T1_file_extension
